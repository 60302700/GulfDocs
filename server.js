...
const dummyData = {
    ...
    lineItems: [
      {
        ...
        spec: 'Intel Core i7-1365U, 16GB RAM, 512GB SSD, 14" FHD',
        sku: "HP-840G10-I7",
        qty: 5,
        unitPrice: "QAR 5,800",
        vatPercent: "5%",
        lineTotal: "QAR 29,000",
      },
      {
        name: 'Dell 27" Monitor (U2723D)',
        spec: "4K UHD IPS, USB-C 90W, Height Adjustable Stand",
        sku: "DELL-U2723D",
        qty: 5,
        unitPrice: "QAR 1,650",
        vatPercent: "5%",
      ...
      {
        name: "Logitech MX Keys Business Keyboard",
        spec: "Wireless, Multi-Device, Backlit, Arabic/English",
        sku: "LOG-MXKEYSBIZ",
        qty: 10,
        unitPrice: "QAR 320",
        vatPercent: "5%",
      ...
      {
        name: "Ergonomic Office Chair (Steelcase Leap V2)",
        spec: "Fully adjustable, Lumbar support, 5-year warranty",
        sku: "STL-LEAP-V2",
        qty: 5,
        unitPrice: "QAR 2,400",
        vatPercent: "5%",
        lineTotal: "QAR 12,000",
      },
    ],
  ...
  quotation: {
    ...
    lineItems: [
      {
        title: "Structured Network Cabling (Cat6A)",
        description:
          "Full office cabling for 50 workstations including patch panels, trunking, and labelling as per TIA-568 standard.",
        qty: 1,
        unitPrice: "QAR 18,000",
        lineTotal: "QAR 18,000",
      },
      {
        title: "Wireless Access Point Installation (Cisco Meraki MR46)",
        description:
          "Supply and install 8x enterprise-grade Wi-Fi 6 access points with cloud management license (1 year).",
        qty: 8,
        unitPrice: "QAR 2,200",
        lineTotal: "QAR 17,600",
      },
      {
        title: "Cybersecurity Firewall (FortiGate 100F)",
        description:
          "Supply, rack-mount, and configure NGFw with IPS, web filtering, and VPN. Includes 1-year UTM subscription.",
        qty: 1,
        unitPrice: "QAR 12,500",
        lineTotal: "QAR 12,500",
      },
      {
        title: "IT Project Management & Site Supervision",
        description:
          "Dedicated project manager for full duration. Includes documentation, handover report, and staff training session.",
        qty: 1,
        unitPrice: "QAR 8,000",
        lineTotal: "QAR 8,000",
      },
  ...
  "billing-details": {
    ...
    items: [
      {
        name: "Annual IT Support Contract — Tier 2",
        qty: 1,
        rate: "QAR 24,000",
        vatPercent: "5%",
        total: "QAR 25,200",
      ...
      {
        name: "Cloud Backup Service (500 GB, 12 Months)",
        qty: 1,
        rate: "QAR 3,600",
        vatPercent: "5%",
        total: "QAR 3,780",
      ...
      {
        name: "On-Site Engineer Visits (4 Visits)",
        qty: 4,
        rate: "QAR 850",
        vatPercent: "5%",
        total: "QAR 3,570",
