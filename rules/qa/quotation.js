/**
 * rules/qa/quotation.js
 *
 * Country: Qatar (QA)
 * Document Type: quotation
 * Authority: Qatar Tax Authority (QTA) / Ministry of Finance Qatar
 *
 * No country-specific quotation e-invoicing requirements verified as of 2026.
 *
...
export default function getRules(issueDate, transactionType = "B2B") {
    ...
    return {
        ...
        source_registry: [
        {
                ...
                "notes": "No country-specific quotation e-invoicing requirements verified as of 2026."
        }
],
        customValidate,
    };
